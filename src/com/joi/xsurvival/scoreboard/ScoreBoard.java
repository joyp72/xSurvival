		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				if (m != null) {
					...
					Score life = main.getScore(ChatColor.WHITE + "" + ChatColor.BOLD + "Life Expectancy" + ChatColor.RESET + "" + ChatColor.WHITE + ": ");
					life.setScore(i);
					i--;
					...
					Score status = main.getScore(ChatColor.WHITE + "" + ChatColor.BOLD + "Status" + ChatColor.RESET + "" + ChatColor.WHITE + ": ");
					status.setScore(i);
					i--;
